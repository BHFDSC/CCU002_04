...
exp_def<-"_" #choose from INFLU or PNEUM or _. If latter then comment 2 lines above.
...
#pheno_of_interest<-"non-hospitalised"
  ...
  if (exp_def=="INFLU") {
    print("RESULTS FOR INFLUENZA INFECTION")
    df$EXP_CONFIRMED_FLU_PNEUMONIA_PHENOTYPE <- df$EXP2_FLU_PHENOTYPE
    df$EXP_CONFIRMED_FLU_PNEUMONIA_DATE <- df$EXP2_FLU_DATE
  } else if (exp_def=="PNEUM") {
     print("RESULTS FOR PNEUMONIA INFECTION")
     ...
     print("RESULTS FOR BOTH PNEUMONIA AND INFLUENZA INFECTION")
  }
...
#  data[data$overall_event_date > data$EXP_CONFIRMED_FLU_PNEUMONIA_DATE, ]
  ...
  #NA produced in overall_event column for below... also maybe use > instead of >= but need to think
...
#  data$fup<-data$fup+1
  ...
  write.csv(tbl_event_count, paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/event_counts/tbl_event_count_FLU_",outcome_list2,"_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv"), row.names = T)
  ...
  incrate <- data.table::fread(paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/event_counts/tbl_event_count_FLU_",outcome_list2,"_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv"),
                               data.table = FALSE)
  ...
  write.table(inc_rate3, paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/incidence/tbl_incidence_rate_FLU_overall_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv"), append=TRUE, col.name=!file.exists(paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/incidence/tbl_incidence_rate_FLU_overall_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv")))
  write.table(inc_rate4, paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/incidence/tbl_incidence_rate_FLU_infected_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv"), append=TRUE, col.name=!file.exists(paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/incidence/tbl_incidence_rate_FLU_infected_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv")))
  write.table(inc_rate5, paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/incidence/tbl_incidence_rate_FLU_controls_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv"), append=TRUE, col.name=!file.exists(paste0("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/incidence/tbl_incidence_rate_FLU_controls_",time,"_",vaccine,"_",exp_def,"_",week1,"_",pheno_of_interest, "_",censor,"_",excl,"_",Sys.Date(),".csv")))
...
####  Median person time of those with an event within each time period used for plotting figures. #####
  ...
  #N_DISORDER was excluded and used to be after EVER ANY CVD
    ...
    write(c("event term estimate conf.low conf.high std.error n.event subgroup"), 
        paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
  ...
  purrr::map(outcome_list, function(x) {
    ...
    cat(paste0(substring(x,9,40),' ',cov, apply(s$coefficients, 1, 
               ...
               collapse = '\n'), '\n', sep = '', 
        file = paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
    invisible(model)
  })
  
  #Read in "Extensive..." results files after running Coxph then do the following
  estimates <- data.table::fread(paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'),
                               data.table = FALSE)
  ...
  #Then save to csv.
  write.table(estimates, paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), row.names = FALSE)
  ...
  # #-------------------------------------------------------------------------------
   ...
   write(c("event term estimate conf.low conf.high std.error n.event subgroup"),
         paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_agegroup_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
   ...
   lapply(split(survival_data, survival_data$agegroup), function(y)
     purrr::map(outcome_list, function(x) {
       ...
       cat(paste0(substring(x,9,40),' ',cov, apply(s$coefficients, 1,
                  ...
                  " ", y$agegroup[1],
                  collapse = '\n'), '\n', sep = '',
           file = paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_agegroup_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
       invisible(model)
     })
   )
  
   #Read in "Extensive..." results files after running Coxph then do the following
   estimates <- data.table::fread(paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_agegroup_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'),
                                data.table = FALSE)
   estimates <- estimates %>% filter(term %in% term[grepl("^week",term)])
   ...
   #Then save to csv.
   write.table(estimates, paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_agegroup_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), row.names = FALSE)
  
   # For stratification by sex
   #-------------------------------------------------------------------------------

   write(c("event term estimate conf.low conf.high std.error n.event subgroup"),
         paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_Sex_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
   ...
   lapply(split(survival_data, survival_data$sex_label), function(y) #sex_label has replace COV_SEX here
     purrr::map(outcome_list, function(x) {
       ...
       cat(paste0(substring(x,9,40),' ',cov, apply(s$coefficients, 1,
                  ...
                  " ", y$sex_label[1],
                  collapse = '\n'), '\n', sep = '',
           file = paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_Sex_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
       invisible(model)
     })
   )

   #Read in "Extensive..." results files after running Coxph then do the following
   estimates <- data.table::fread(paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_Sex_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'),
                                data.table = FALSE)
   estimates <- estimates %>% filter(term %in% term[grepl("^week",term)])
   tmp2<- data.frame(term=c("week1_0.142857143", "week1.142857143_1", "week2_4", "week5_16", "week17_75"),
                     Weeks_category=c(1,2,3,4,5))
   ...
   #Then save to csv.
   write.table(estimates, paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_Sex_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), row.names = FALSE)
   ...
   write(c("event term estimate conf.low conf.high std.error n.event subgroup"),
         paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_hxCVD_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
   ...
   lapply(split(survival_data, survival_data$cvd_label), function(y)
     purrr::map(outcome_list, function(x) {
       ...
       cat(paste0(substring(x,9,40),' ',cov, apply(s$coefficients, 1,
                  ...
                  " ", y$cvd_label[1],
                  collapse = '\n'), '\n', sep = '',
           file = paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_hxCVD_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
       invisible(model)
     })
   )

   #Read in "Extensive..." results files after running Coxph then do the following
   estimates <- data.table::fread(paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_hxCVD_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'),
                                data.table = FALSE)
   estimates <- estimates %>% filter(term %in% term[grepl("^week",term)])
   ...
   #Then save to csv.
   write.table(estimates, paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_hxCVD_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'),  row.names = FALSE)
   ...
   write(c("event term estimate conf.low conf.high std.error n.event subgroup"),
         paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_antiplatelet_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
   ...
   lapply(split(survival_data, survival_data$antiplatelet_label), function(y)
     purrr::map(outcome_list, function(x) {
       ...
       cat(paste0(substring(x,9,40),' ',cov, apply(s$coefficients, 1,
                  ...
                  collapse = '\n'), '\n', sep = '',
           file = paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_antiplatelet_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
       invisible(model)
     })
   )

   #Read in "Extensive..." results files after running Coxph then do the following
   estimates <- data.table::fread(paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_antiplatelet_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'),
                                data.table = FALSE)
   estimates <- estimates %>% filter(term %in% term[grepl("^week",term)])
   tmp2<- data.frame(term=c("week1_0.142857143", "week1.142857143_1", "week2_4", "week5_16", "week17_75"),
                     Weeks_category=c(1,2,3,4,5))
  ...
  #Filter to columns and terms of interest
   ...
   #Then save to csv.
   write.table(estimates, paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_antiplatelet_cox_results',exp_def,"_",week1,'_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'),  row.names = FALSE)
...
cov_model <- "week1:agegroup + week2_4:agegroup + week5_16:agegroup + week17_75:agegroup + COV_AGE + COV_SEX + age_sq + COV_DEPRIVATION + COV_EVER_DEMENTIA + COV_EVER_CKD + hx_hypertension + COV_SMOKING_STATUS + COV_ELIXHAUSER_SCORE + COV_EVER_OBESITY + COV_EVER_COPD + COV_EVER_CANCER + COV_EVER_DIABETES + COV_EVER_ANY_CVD + COV_N_DISORDER + COV_SURGERY_LASTYR + COV_LIPID_MEDS + hx_antiplat_anticoag + CARE_HOME"

cov <-c("age ", "sex ", "age_squared ", "DEPRIVATIONMissing", "DEPRIVATION2", "DEPRIVATION3", "DEPRIVATION4", "DEPRIVATION5", "EVER_DEMENTIA", "EVER_CKD"
          , "hypertension ", "SMOKING_STATUS_Missing ", "SMOKING_STATUS_Ex-smoker ", "SMOKING_STATUS_Current-smoker ",
          "ELIXHAUSER_SCORE ", "EVER_OBESITY ", "EVER_COPD ", "EVER_CANCER ", "EVER_DIABETES ",
          "EVER_ANY_CVD ", "N_DISORDER ", "SURGERY_LASTYR ", "LIPID_MEDS ", "antiplat_anticoag ", "CARE_HOME ",
        "week1:agegroup<60 ", "week1:agegroup60+ ", "week2_4:agegroup<60 ", "week2_4:agegroup60+ ",
        "week5_16:agegroup<60 ", "week5_16:agegroup60+ ", "week17_75:agegroup<60 ", "week17_75:agegroup60+ ")

write(c("event term estimate conf.low conf.high std.error n.event subgroup"),
      paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_agegroup2_cox_results_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
    ...
    cat(paste0(substring(x,9,40),' ',cov, apply(s$coefficients, 1,
                                                function(x) {
                                                  paste0(" ", round(exp(x[1]), 3), #change to cov1 and cov2 depending on the list of covariates used
                                                         ...
                                                         " ", summary(model)$nevent)}),
               collapse = '\n'), '\n', sep = '',
        file = paste0('P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/',time,'/',adjust,'_agegroup2_cox_results_FLU_',Sys.Date(),"_",vaccine,"_",pheno_of_interest,"_",outcome_list2, "_",censor,"_",excl,'.csv'), append = TRUE)
    invisible(model)
  })
  }
  
} #this closes the first loop for(i in 1:length(outcomes_names2))
#coxph(Surv(time = tstart, time2 = tstop, event = BIN_OUT_HF) ~ COV_AGE,survival_data, id = ALF_E, weights = survival_data$cox_weights)
