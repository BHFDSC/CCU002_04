...
sink("P:/keenes/Projects/CCU002-04/results/COVID_cox_analysis/AER/Covid_excess_events_week1.log",append=FALSE,split=TRUE)
...
# data$CENSOR_DATE <- as.IDate(ifelse((data$EXP_CONFIRMED_COVID_PHENOTYPE=="non-hospitalised"), 
#                                    data$EXP_CONFIRMED_COVID19_DATE,NA),origin='1970-01-01')
# 
# data$EXP_CONFIRMED_COVID19_DATE <- as.Date(ifelse((!is.na(data$CENSOR_DATE)) & 
#                                                                (data$EXP_CONFIRMED_COVID19_DATE >= data$CENSOR_DATE), 
...
HR<-c(
  rep(55.3,7),
  rep(14.8,21),rep(6.57,84),rep(1.97,413),rep(1.00,205))
HR_LB<-c(
  rep(38.5,7),
  rep(9.53,21),rep(4.49,84),rep(1.28,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(79.6,7),
  rep(23.1,21),rep(9.62,84),rep(3.03,413),rep(1.00,205)) #HR lower 95% CI
...
HR<-c(
  rep(53.9,7),
  rep(30.6,21),rep(6.52,84),rep(2.54,413),rep(1.00,205))
HR_LB<-c(
  rep(37.4,7),
  rep(22.3,21),rep(4.36,84),rep(1.70,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(77.5,7),
  rep(41.9,21),rep(9.77,84),rep(3.80,413),rep(1.00,205)) #HR lower 95% CI
...
HR<-c(
  rep(48.5,7),
  rep(56.8,21),rep(8.3,84),rep(2.63,413),rep(1.00,205))
HR_LB<-c(
  rep(25.1,7),
  rep(39.1,21),rep(4.89,84),rep(1.49,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(93.7,7),
  rep(82.3,21),rep(14.1,84),rep(4.66,413),rep(1.00,205)) #HR lower 95% CI
...
HR<-c(
  rep(57.2,7),
  rep(14.6,21),rep(6.07,84),rep(2.11,413),rep(1.00,205))
HR_LB<-c(
  rep(43.2,7),
  rep(10.2,21),rep(4.28,84),rep(1.49,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(75.6,7),
  rep(20.9,21),rep(8.4,84),rep(2.97,413),rep(1.00,205)) #HR lower 95% CI
...
HR<-c(
  rep(20.4,7),
  rep(5.24,21),rep(2.02,84),rep(1.97,413),rep(1.00,205))
HR_LB<-c(
  rep(16.4,7),
  rep(3.76,21),rep(1.47,84),rep(1.61,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(25.4,7),
  rep(7.31,21),rep(2.78,84),rep(2.41,413),rep(1.00,205)) #HR lower 95% CI
...
HR<-c(
  rep(21.1,7),
  rep(5.29,21),rep(2.19,84),rep(1.29,413),rep(1.00,205))
HR_LB<-c(
  rep(16.4,7),
  rep(3.97,21),rep(1.67,84),rep(1.03,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(27.3,7),
  rep(7.05,21),rep(2.88,84),rep(1.62,413),rep(1.00,205)) #HR lower 95% CI
...
HR<-c(
  rep(28.5,7),
  rep(13.4,21),rep(3.05,84),rep(1.14,413),rep(1.00,205))
HR_LB<-c(
  rep(16.9,7),
  rep(8.41,21),rep(1.80,84),rep(0.68,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(48.2,7),
  rep(21.3,21),rep(5.16,84),rep(1.89,413),rep(1.00,205)) #HR lower 95% CI
...
HR<-c(
  rep(20.1,7),
  rep(4.51,21),rep(2.02,84),rep(1.69,413),rep(1.00,205))
HR_LB<-c(
  rep(16.9,7),
  rep(3.53,21),rep(1.61,84),rep(1.44,413),rep(1.00,205)) #HR upper 95% CI
HR_UB<-c(
  rep(24.0,7),
  rep(5.77,21),rep(2.53,84),rep(1.97,413),rep(1.00,205)) #HR lower 95% CI
...
dev.print(file = "P:/keenes/Projects/CCU002-04/results/COVID_cox_analysis/AER/AER_COVID_week1.png", device=png, width = 800, height = 400)
