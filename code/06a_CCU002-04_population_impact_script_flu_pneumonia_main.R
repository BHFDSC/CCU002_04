...
sink("P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/AER/Flu_excess_events_main.log",append=FALSE,split=TRUE)
...
HR<-c(
  rep(12,7),
  rep(11.9,21),rep(4.9,84),rep(1.64,413),rep(1.00,935))
HR_LB<-c(
  rep(7.2,7),
  rep(8.7,21),rep(3.7,84),rep(1.27,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(21,7),
  rep(16.2,21),rep(6.4,84),rep(2.13,413),rep(1.00,935)) #HR lower 95% CI
...
HR<-c(
  rep(15,7),
  rep(10,21),rep(5.5,84),rep(2.02,413),rep(1.00,935))
HR_LB<-c(
  rep(8.7,7),
  rep(6.8,21),rep(4.1,84),rep(1.55,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(25,7),
  rep(14,21),rep(7.3,84),rep(2.63,413),rep(1.00,935)) #HR lower 95% CI
...
HR<-c(
  rep(62,7),
  rep(24,21),rep(10.3,84),rep(4.4,413),rep(1.00,935))
HR_LB<-c(
  rep(35,7),
  rep(14.2,21),rep(6.8,84),rep(3.1,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(109,7),
  rep(39.4,21),rep(15.6,84),rep(6.1,413),rep(1.00,935)) #HR lower 95% CI
...
HR<-c(
  rep(8.5,7),
  rep(9.6,21),rep(4.5,84),rep(1.43,413),rep(1.00,935))
HR_LB<-c(
  rep(5.2,7),
  rep(7.3,21),rep(3.6,84),rep(1.15,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(13.9,7),
  rep(12.6,21),rep(5.6,84),rep(1.79,413),rep(1.00,935)) #HR lower 95% CI
...
HR<-c(
  rep(4.4,7),
  rep(3.5,21),rep(1.9,84),rep(1.44,413),rep(1.00,935))
HR_LB<-c(
  rep(3.2,7),
  rep(2.85,21),rep(1.6,84),rep(1.29,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(6.2,7),
  rep(4.39,21),rep(2.26,84),rep(1.61,413),rep(1.00,935)) #HR lower 95% CI
...
HR<-c(
  rep(6.10,7),
  rep(4.0,21),rep(2.09,84),rep(1.37,413),rep(1.00,935))
HR_LB<-c(
  rep(4.6,7),
  rep(3.2,21),rep(1.78,84),rep(1.22,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(8.0,7),
  rep(4.8,21),rep(2.44,84),rep(1.53,413),rep(1.00,935)) #HR lower 95% CI
...
HR<-c(
  rep(3.1,7),
  rep(2.5,21),rep(1.16,84),rep(0.98,413),rep(1.00,935))
HR_LB<-c(
  rep(1.01,7),
  rep(1.3,21),rep(0.68,84),rep(0.71,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(9.7,7),
  rep(5.1,21),rep(2.00,84),rep(1.34,413),rep(1.00,935)) #HR lower 95% CI
...
HR<-c(
  rep(5.4,7),
  rep(3.9,21),rep(2.1,84),rep(1.47,413),rep(1.00,935))
HR_LB<-c(
  rep(4.4,7),
  rep(3.3,21),rep(1.9,84),rep(1.36,413),rep(1.00,935)) #HR upper 95% CI
HR_UB<-c(
  rep(6.8,7),
  rep(4.5,21),rep(2.4,84),rep(1.60,413),rep(1.00,935)) #HR lower 95% CI
...
dev.print(file = "P:/keenes/Projects/CCU002-04/results/FLU_cox_analysis/AER/AER_FLU_main.png", device=png, width = 800, height = 400)
